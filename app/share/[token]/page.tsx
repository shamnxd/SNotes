...
export default function ShareAccessPage({
  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] dark:bg-[#0B0F17] text-slate-800 dark:text-slate-100 flex flex-col font-sans transition-colors duration-200">
      {/* Header */}
      <header className="border-b border-slate-200/80 dark:border-slate-800 bg-white dark:bg-[#151D2A]">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs font-semibold text-[#059669] dark:text-[#00E5A3] bg-[#E6F8F2] dark:bg-[#00C48C]/20 border border-[#A7F3D0] dark:border-[#00C48C]/30 px-3.5 py-1 rounded-full">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 py-12">
        {status === SHARE_STATUS.LOADING && (
          <div className="w-full max-w-lg bg-white dark:bg-[#151D2A] border border-slate-200/80 dark:border-slate-800 rounded-2xl p-8 shadow-sm text-center animate-pulse">
            <div className="w-12 h-12 rounded-2xl bg-[#E6F8F2] dark:bg-[#00C48C]/20 mx-auto mb-4" />
            <div className="h-4 bg-slate-100 dark:bg-slate-800 rounded w-1/2 mx-auto mb-2" />
            ...
            <form onSubmit={handleUnlockPassword} className="flex flex-col gap-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-sm text-slate-900 dark:text-slate-100 focus:outline-none focus:border-[#00C48C] focus:ring-1 focus:ring-[#00C48C]"
                />
              </div>
        ...
        {[
          ...
          <div className="w-full max-w-md bg-white dark:bg-[#151D2A] border border-slate-200/80 dark:border-slate-800 rounded-2xl p-8 shadow-sm text-center">
            <div className="w-12 h-12 rounded-2xl bg-rose-50 dark:bg-rose-950/40 text-rose-600 dark:text-rose-400 flex items-center justify-center mx-auto mb-4 border border-rose-200 dark:border-rose-800">
            ...
            <Link
              href="/"
              className="inline-flex items-center gap-2 px-5 py-2.5 bg-slate-900 dark:bg-slate-800 hover:bg-black dark:hover:bg-slate-700 text-white font-semibold text-sm rounded-xl transition-all"
            >
              Go to Home Page
            </Link>
          </div>
        ...
        {status === SHARE_STATUS.SUCCESS && note && (
          <div className="w-full max-w-3xl bg-white dark:bg-[#151D2A] border border-slate-200/80 dark:border-slate-800 rounded-2xl p-8 shadow-sm">
            <div className="flex items-start justify-between gap-4 mb-6 pb-6 border-b border-slate-100 dark:border-slate-800">
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 px-4 py-2 text-xs font-semibold text-[#059669] dark:text-[#00E5A3] bg-[#E6F8F2] dark:bg-[#00C48C]/20 border border-[#A7F3D0] dark:border-[#00C48C]/30 hover:bg-[#d4f3e7] dark:hover:bg-[#00C48C]/30 rounded-xl transition-all"
              >
                {copied ? <Check className="w-4 h-4 text-[#059669] dark:text-[#00E5A3]" /> : <Copy className="w-4 h-4" />}
                <span>{copied ? "Copied!" : "Copy Content"}</span>
              </button>
            </div>

            <div className="bg-slate-50 dark:bg-slate-800/60 border border-slate-200/80 dark:border-slate-700/60 rounded-xl p-6 font-mono text-sm text-slate-900 dark:text-slate-100 whitespace-pre-wrap leading-relaxed">
              {note.content}
            </div>
          </div>
        )}

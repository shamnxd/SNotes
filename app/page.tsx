  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center bg-gradient-to-b from-[#2F8CFF] to-white px-4 pt-6">
        ...
        <nav className="flex items-center justify-between bg-[#4E9EFF] border border-white/40 rounded-full pl-4 md:pl-6 pr-3 md:pr-2 py-1.5 w-full max-w-3xl relative">
          ...
          >
            ...
            <a href="#security" onClick={() => setMobileOpen(false)} className="text-gray-50 hover:text-white text-sm">
              Security
            </a>
        ...
        <p className="text-sm md:text-base/6.5 text-white text-center max-w-[480px] mt-2">
        ...
        <div className="flex gap-4 mt-8">
          <Link
            href="/register"
            className="border border-white hover:bg-sky-200/30 text-white text-sm px-6 py-3 rounded-full tracking-tight transition cursor-pointer"
          >
            Get started for free
          </Link>
          <Link
            href="/login"
            className="bg-white hover:bg-white/90 text-sm text-zinc-600 px-5 py-3 rounded-full tracking-tight transition cursor-pointer"
          >
            Explore templates
          </Link>
        </div>

        {/* Hero Dashboard Preview Image / Mockup */}
        <div className="mt-12.5 w-full">
          <div className="max-h-64 md:max-h-96 w-full max-w-[926px] mx-auto border-4 md:border-8 border-blue-300 rounded-2xl md:rounded-t-2xl md:rounded-b-none md:border-b-0 overflow-hidden bg-white text-left shadow-2xl p-6 sm:p-8">
            ...
            {/* Inner Stats Overview */}
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
              <div className="bg-slate-50 border border-slate-200/70 p-4 rounded-xl">
                <div className="text-[11px] font-semibold text-slate-400 uppercase tracking-wider">TOTAL'S SALE</div>
                <div className="text-xl font-bold text-slate-900 mt-1">$4,450</div>
                <div className="text-[11px] font-medium text-emerald-600 mt-1">+ 28% ↑</div>
              </div>

              <div className="bg-slate-50 border border-slate-200/70 p-4 rounded-xl">
                <div className="text-[11px] font-semibold text-slate-400 uppercase tracking-wider">TOTAL PROFITS</div>
                <div className="text-xl font-bold text-slate-900 mt-1">$42,450</div>
                <div className="text-[11px] font-medium text-rose-500 mt-1">+ 22% ↓</div>
              </div>

              <div className="bg-slate-50 border border-slate-200/70 p-4 rounded-xl">
                <div className="text-[11px] font-semibold text-slate-400 uppercase tracking-wider">TODAY'S ORDERS</div>
                <div className="text-xl font-bold text-slate-900 mt-1">450</div>
                <div className="text-[11px] font-medium text-emerald-600 mt-1">+ 22% ↑</div>
              </div>
      ...
      <footer className="w-full border-t border-slate-200 bg-white py-8 text-center text-xs text-slate-500">
        <div className="max-w-6xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div>&copy; {new Date().getFullYear()} SNotes. Powered by PrebuiltUI Hero Design.</div>
        </div>
      </footer>
    </>
  );
